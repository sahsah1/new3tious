...
public class FAT implements Serializable
{
    ...
    private final static long serialVersionUID = -823245393003304760L;
    ...
    public FAT withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public FAT withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public FAT withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public FAT withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
