...
public class FOLDFE_ implements Serializable
{
    ...
    private final static long serialVersionUID = 1705223292913824838L;
    ...
    public FOLDFE_ withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public FOLDFE_ withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public FOLDFE_ withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public FOLDFE_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FOLDFE_) == false) {
            return false;
        }
        FOLDFE_ rhs = ((FOLDFE_) other);
