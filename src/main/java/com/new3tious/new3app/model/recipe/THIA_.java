...
public class THIA_ implements Serializable
{
    ...
    private final static long serialVersionUID = -7997395525642486485L;
    ...
    public THIA_ withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public THIA_ withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public THIA_ withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public THIA_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof THIA_) == false) {
            return false;
        }
        THIA_ rhs = ((THIA_) other);
