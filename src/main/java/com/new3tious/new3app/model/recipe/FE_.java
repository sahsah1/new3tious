...
public class FE_ implements Serializable
{
    ...
    private final static long serialVersionUID = -2446252188846135583L;
    ...
    public FE_ withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public FE_ withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public FE_ withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public FE_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
