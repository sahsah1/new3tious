...
public class NIA_ implements Serializable
{
    ...
    private final static long serialVersionUID = -224795148670140524L;
    ...
    public NIA_ withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public NIA_ withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public NIA_ withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public NIA_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NIA_) == false) {
            return false;
        }
        NIA_ rhs = ((NIA_) other);
