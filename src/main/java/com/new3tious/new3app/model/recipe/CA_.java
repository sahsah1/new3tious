...
public class CA_ implements Serializable
{
    ...
    private final static long serialVersionUID = -9157678096377945408L;
    ...
    public CA_ withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public CA_ withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public CA_ withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public CA_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
