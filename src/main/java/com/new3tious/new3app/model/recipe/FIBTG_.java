...
public class FIBTG_ implements Serializable
{
    ...
    private final static long serialVersionUID = 8794836719548908774L;
    ...
    public FIBTG_ withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public FIBTG_ withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public FIBTG_ withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public FIBTG_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FIBTG_) == false) {
            return false;
        }
        FIBTG_ rhs = ((FIBTG_) other);
