...
public class VITD implements Serializable
{
    ...
    private final static long serialVersionUID = -1547137236511148914L;
    ...
    public VITD withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public VITD withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public VITD withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public VITD withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof VITD) == false) {
            return false;
        }
        VITD rhs = ((VITD) other);
