...
public class FAPU implements Serializable
{
    ...
    private final static long serialVersionUID = 1833463012286432318L;
    ...
    public FAPU withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public FAPU withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public FAPU withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public FAPU withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FAPU) == false) {
            return false;
        }
        FAPU rhs = ((FAPU) other);
