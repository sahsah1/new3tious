...
public class VITK1_ implements Serializable
{
    ...
    private final static long serialVersionUID = 2101498553512344778L;
    ...
    public VITK1_ withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public VITK1_ withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public VITK1_ withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public VITK1_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof VITK1_) == false) {
            return false;
        }
        VITK1_ rhs = ((VITK1_) other);
