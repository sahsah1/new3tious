...
public class VITB12_ implements Serializable
{
    ...
    private final static long serialVersionUID = -3404849067596507660L;
    ...
    public VITB12_ withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public VITB12_ withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public VITB12_ withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public VITB12_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof VITB12_) == false) {
            return false;
        }
        VITB12_ rhs = ((VITB12_) other);
