...
public class CHOCDF_ implements Serializable
{
    ...
    private final static long serialVersionUID = -7240986967654455319L;
    ...
    public CHOCDF_ withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public CHOCDF_ withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public CHOCDF_ withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public CHOCDF_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CHOCDF_) == false) {
            return false;
        }
        CHOCDF_ rhs = ((CHOCDF_) other);
