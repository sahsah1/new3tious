...
public class P_ implements Serializable
{
    ...
    private final static long serialVersionUID = 917292761577297790L;
    ...
    public P_ withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public P_ withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public P_ withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public P_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
