...
public class FAMS implements Serializable
{
    ...
    private final static long serialVersionUID = 7353647749714189812L;
    ...
    public FAMS withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public FAMS withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public FAMS withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public FAMS withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FAMS) == false) {
            return false;
        }
        FAMS rhs = ((FAMS) other);
