...
public class VITD_ implements Serializable
{
    ...
    private final static long serialVersionUID = 2705432128520569228L;
    ...
    public VITD_ withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public VITD_ withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public VITD_ withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public VITD_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof VITD_) == false) {
            return false;
        }
        VITD_ rhs = ((VITD_) other);
