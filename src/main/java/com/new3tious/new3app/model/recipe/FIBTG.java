...
public class FIBTG implements Serializable
{
    ...
    private final static long serialVersionUID = 8140275071737346733L;
    ...
    public FIBTG withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public FIBTG withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public FIBTG withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public FIBTG withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FIBTG) == false) {
            return false;
        }
        FIBTG rhs = ((FIBTG) other);
