...
public class ENERCKCAL implements Serializable
{
    ...
    private final static long serialVersionUID = -7605590623635595589L;
    ...
    public ENERCKCAL withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public ENERCKCAL withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public ENERCKCAL withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public ENERCKCAL withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ENERCKCAL) == false) {
            return false;
        }
        ENERCKCAL rhs = ((ENERCKCAL) other);
