...
public class NA implements Serializable
{
    ...
    private final static long serialVersionUID = -9135599835889704335L;
    ...
    public NA withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public NA withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public NA withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public NA withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
