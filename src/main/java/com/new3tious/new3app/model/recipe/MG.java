...
public class MG implements Serializable
{
    ...
    private final static long serialVersionUID = 2903522165697330206L;
    ...
    public MG withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public MG withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public MG withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public MG withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
