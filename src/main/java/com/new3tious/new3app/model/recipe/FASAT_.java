...
public class FASAT_ implements Serializable
{
    ...
    private final static long serialVersionUID = -4582793740887081086L;
    ...
    public FASAT_ withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public FASAT_ withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public FASAT_ withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public FASAT_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FASAT_) == false) {
            return false;
        }
        FASAT_ rhs = ((FASAT_) other);
