...
public class FOLFD implements Serializable
{
    ...
    private final static long serialVersionUID = 8949730691158910162L;
    ...
    public FOLFD withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public FOLFD withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public FOLFD withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public FOLFD withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FOLFD) == false) {
            return false;
        }
        FOLFD rhs = ((FOLFD) other);
