...
public class RIBF implements Serializable
{
    ...
    private final static long serialVersionUID = -1642239817121167726L;
    ...
    public RIBF withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public RIBF withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public RIBF withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public RIBF withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RIBF) == false) {
            return false;
        }
        RIBF rhs = ((RIBF) other);
