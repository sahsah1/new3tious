...
public class CA implements Serializable
{
    ...
    private final static long serialVersionUID = 762103594106070525L;
    ...
    public CA withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public CA withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public CA withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public CA withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
