...
public class PROCNT_ implements Serializable
{
    ...
    private final static long serialVersionUID = 1076549053843306335L;
    ...
    public PROCNT_ withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public PROCNT_ withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public PROCNT_ withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public PROCNT_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PROCNT_) == false) {
            return false;
        }
        PROCNT_ rhs = ((PROCNT_) other);
