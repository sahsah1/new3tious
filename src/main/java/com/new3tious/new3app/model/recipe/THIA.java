...
public class THIA implements Serializable
{
    ...
    private final static long serialVersionUID = -6881554666224654473L;
    ...
    public THIA withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public THIA withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public THIA withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public THIA withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof THIA) == false) {
            return false;
        }
        THIA rhs = ((THIA) other);
