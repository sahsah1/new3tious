...
public class MG_ implements Serializable
{
    ...
    private final static long serialVersionUID = -2603267041580391163L;
    ...
    public MG_ withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public MG_ withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public MG_ withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public MG_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
