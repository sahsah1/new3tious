...
public class VITARAE implements Serializable
{
    ...
    private final static long serialVersionUID = 5376306223513915928L;
    ...
    public VITARAE withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public VITARAE withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public VITARAE withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public VITARAE withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof VITARAE) == false) {
            return false;
        }
        VITARAE rhs = ((VITARAE) other);
