...
public class ENERCKCAL_ implements Serializable
{
    ...
    private final static long serialVersionUID = 3089144504923466489L;
    ...
    public ENERCKCAL_ withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public ENERCKCAL_ withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public ENERCKCAL_ withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public ENERCKCAL_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ENERCKCAL_) == false) {
            return false;
        }
        ENERCKCAL_ rhs = ((ENERCKCAL_) other);
