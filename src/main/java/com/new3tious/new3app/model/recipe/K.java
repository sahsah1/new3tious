...
public class K implements Serializable
{
    ...
    private final static long serialVersionUID = 8241490254840462245L;
    ...
    public K withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public K withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public K withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
