...
public class NIA implements Serializable
{
    ...
    private final static long serialVersionUID = -5828282047790078704L;
    ...
    public NIA withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public NIA withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public NIA withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public NIA withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
