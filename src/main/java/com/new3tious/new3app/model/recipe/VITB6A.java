...
public class VITB6A implements Serializable
{
    ...
    private final static long serialVersionUID = -8962759175897093257L;
    ...
    public VITB6A withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public VITB6A withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public VITB6A withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public VITB6A withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof VITB6A) == false) {
            return false;
        }
        VITB6A rhs = ((VITB6A) other);
