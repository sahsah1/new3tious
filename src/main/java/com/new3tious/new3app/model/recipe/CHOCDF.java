...
public class CHOCDF implements Serializable
{
    ...
    private final static long serialVersionUID = 8943313287094080799L;
    ...
    public CHOCDF withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public CHOCDF withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public CHOCDF withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public CHOCDF withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CHOCDF) == false) {
            return false;
        }
        CHOCDF rhs = ((CHOCDF) other);
