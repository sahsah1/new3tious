...
public class CHOLE implements Serializable
{
    ...
    private final static long serialVersionUID = 666168689566595296L;
    ...
    public CHOLE withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public CHOLE withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public CHOLE withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public CHOLE withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CHOLE) == false) {
            return false;
        }
        CHOLE rhs = ((CHOLE) other);
