...
public class K_ implements Serializable
{
    ...
    private final static long serialVersionUID = 2394790651604132398L;
    ...
    public K_ withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public K_ withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public K_ withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public K_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
