...
public class ZN_ implements Serializable
{
    ...
    private final static long serialVersionUID = -9159891833850538121L;
    ...
    public ZN_ withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public ZN_ withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public ZN_ withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public ZN_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
