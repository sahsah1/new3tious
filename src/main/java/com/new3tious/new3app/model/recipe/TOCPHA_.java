...
public class TOCPHA_ implements Serializable
{
    ...
    private final static long serialVersionUID = -7944809870023762928L;
    ...
    public TOCPHA_ withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public TOCPHA_ withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public TOCPHA_ withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public TOCPHA_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TOCPHA_) == false) {
            return false;
        }
        TOCPHA_ rhs = ((TOCPHA_) other);
