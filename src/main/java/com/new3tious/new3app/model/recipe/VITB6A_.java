...
public class VITB6A_ implements Serializable
{
    ...
    private final static long serialVersionUID = 7096004628776378749L;
    ...
    public VITB6A_ withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public VITB6A_ withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public VITB6A_ withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public VITB6A_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof VITB6A_) == false) {
            return false;
        }
        VITB6A_ rhs = ((VITB6A_) other);
