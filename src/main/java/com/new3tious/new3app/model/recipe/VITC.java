...
public class VITC implements Serializable
{
    ...
    private final static long serialVersionUID = -1233562914287516903L;
    ...
    public VITC withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public VITC withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public VITC withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public VITC withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof VITC) == false) {
            return false;
        }
        VITC rhs = ((VITC) other);
