...
public class PROCNT implements Serializable
{
    ...
    private final static long serialVersionUID = 4850554567748166046L;
    ...
    public PROCNT withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public PROCNT withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public PROCNT withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public PROCNT withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PROCNT) == false) {
            return false;
        }
        PROCNT rhs = ((PROCNT) other);
