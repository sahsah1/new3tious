...
public class FOLDFE implements Serializable
{
    ...
    private final static long serialVersionUID = -9009381429217511295L;
    ...
    public FOLDFE withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public FOLDFE withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public FOLDFE withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public FOLDFE withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FOLDFE) == false) {
            return false;
        }
        FOLDFE rhs = ((FOLDFE) other);
