...
public class VITARAE_ implements Serializable
{
    ...
    private final static long serialVersionUID = 1980486454377161586L;
    ...
    public VITARAE_ withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public VITARAE_ withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public VITARAE_ withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public VITARAE_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof VITARAE_) == false) {
            return false;
        }
        VITARAE_ rhs = ((VITARAE_) other);
