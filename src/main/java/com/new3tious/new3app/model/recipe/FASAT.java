...
public class FASAT implements Serializable
{
    ...
    private final static long serialVersionUID = 5573409379387977724L;
    ...
    public FASAT withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public FASAT withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public FASAT withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public FASAT withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FASAT) == false) {
            return false;
        }
        FASAT rhs = ((FASAT) other);
