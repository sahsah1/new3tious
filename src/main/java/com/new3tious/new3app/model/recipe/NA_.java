...
public class NA_ implements Serializable
{
    ...
    private final static long serialVersionUID = -5247561162313371050L;
    ...
    public NA_ withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public NA_ withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public NA_ withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public NA_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
