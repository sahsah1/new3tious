...
public class VITC_ implements Serializable
{
    ...
    private final static long serialVersionUID = -2960117973854120672L;
    ...
    public VITC_ withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public VITC_ withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public VITC_ withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public VITC_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof VITC_) == false) {
            return false;
        }
        VITC_ rhs = ((VITC_) other);
