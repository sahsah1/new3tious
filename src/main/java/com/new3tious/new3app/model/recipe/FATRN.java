...
public class FATRN implements Serializable
{
    ...
    private final static long serialVersionUID = -2630602659521337914L;
    ...
    public FATRN withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public FATRN withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public FATRN withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public FATRN withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FATRN) == false) {
            return false;
        }
        FATRN rhs = ((FATRN) other);
