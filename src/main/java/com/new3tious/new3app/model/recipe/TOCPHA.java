...
public class TOCPHA implements Serializable
{
    ...
    private final static long serialVersionUID = -6780384384817275211L;
    ...
    public TOCPHA withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public TOCPHA withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public TOCPHA withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public TOCPHA withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TOCPHA) == false) {
            return false;
        }
        TOCPHA rhs = ((TOCPHA) other);
