...
public class RIBF_ implements Serializable
{
    ...
    private final static long serialVersionUID = 205038425509956285L;
    ...
    public RIBF_ withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public RIBF_ withQuantity(Double quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public RIBF_ withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public RIBF_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RIBF_) == false) {
            return false;
        }
        RIBF_ rhs = ((RIBF_) other);
